...
$this->title = <?= $generator->generateString(Inflector::pluralize($className)) ?>;
        ...
        <?="<?="?>GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> '<?= $generator->generateString('Create new {modelClass}', ['modelClass' => $modelClass]) ?>','class'=>'btn btn-default']).
